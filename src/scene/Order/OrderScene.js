        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.itemContainer}>
                    <OrderMenuItem title='待付款' icon={require('../../assets/images/tabbar/icon_tabbar_home_sel.png')} />
                    <OrderMenuItem title='待使用' icon={require('../../assets/images/tabbar/icon_tabbar_home_sel.png')} />
                    <OrderMenuItem title='待评价' icon={require('../../assets/images/tabbar/icon_tabbar_home_sel.png')} />
                    <OrderMenuItem title='退款/售后' icon={require('../../assets/images/tabbar/oicon_tabbar_home_sel.png')} />
                </View>
